...
int find_min(void)
{
int min = ((voter_count *candidate_count)+1);
...
// string winner2 ;
//             {
//                 variable = candidates[x].votes;
//                 winner = candidates[x].name;
//             }
//             if(candidates[x].votes > variable )
//             {
//                 variable = candidates[x].votes;
//                 winner = candidates[x].name;
//             }

//             else if((candidates[x].votes)== variable && (equal(x,voter_count)==true) )
//             {
//                 winner2 = candidates[x].name;
//                 printf("%s\n%s\n",winner,winner2);
//                 return;
//             }
//      }
